...
const Navbar = () => {
  ...
  return (
    <nav
      className={`w-full px-4 md:px-8 py-4 flex justify-between items-center fixed top-0 left-0 z-50 transition-all duration-300 ${
        isScrolled
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-[70px] md:top-[80px] left-0 w-full h-[calc(100vh-70px)] md:h-[calc(100vh-80px)] bg-[#041C55] text-white z-40 px-4 sm:px-6 md:px-16 py-6 flex flex-col overflow-y-auto"
          >
            {/* CONTENT */}
            <div className="flex flex-col lg:flex-row justify-between gap-10">
              ...
              <div className="max-w-xl">
                ...
                <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                  Your trusted property experts in Leicestershire. Specialising
                  in sales, lettings, development, property management, and
                  block management.
                </p>
              </div>
            ...
            {/* FOOTER */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center pt-6 mt-auto gap-6">
              {/* Locations */}
