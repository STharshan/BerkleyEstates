export const about = {
  Propertymanagement: {
    title: "Premium property care, so you can focus on what truly matters.",
    description: "Managing a property is more than just maintenance-it's about safeguarding your investment with care and expertise. Our personalised property management services take the stress off your shoulders, ensuring your home is well-maintained and in trusted hands. Experience hassle-free property ownership with our expert support.",
...
export const trustedContent = {
  "Propertymanagement": {
    ...
    description: "Finding and keeping reliable tenants to preserving your property's value and staying on top of legal requirements, we handle every aspect with precision-giving you the freedom to enjoy worry-free ownership.",
    image: "/trust.jpeg",
    accordions: [
      {
